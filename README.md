...
# AI провайдер (openai, mock, local)
AI_PROVIDER=mock
...
### Вариант 1: OpenAI API (если доступен в вашем регионе)
...
### Вариант 2: Мок AI (для тестирования)
Если OpenAI недоступен в вашем регионе, используйте мок AI:
```env
AI_PROVIDER=mock
```

### Вариант 3: Локальный AI
Для использования локальных AI моделей:
```env
AI_PROVIDER=local
```
